...
#set output "figure_scripts/fig_comp_Epy_dynamic.eps"
...
plot dat1 index 0 u 1:3 w l lw 5 lc 'black' notitle "nofrictions", \
     ...
     dat3 index 0 u 1:3 w l lw 5 dt (3,3) lc 'blue' notitle "delays"
...
set key t r
plot dat1 index 0 u 1:7 w l lw 5 lc 'black' title "no frictions", \
     dat2 index 0 u 1:7 w l lw 5 dt (1,1) lc 'red' title "Querataro", \
     dat3 index 0 u 1:7 w l lw 5 dt (3,3) lc 'blue' title "Tamaulipas"
